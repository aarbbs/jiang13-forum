...
docker push hangzhang714128/jiang13-forum:1.1.1
...
```bash
docker build --build-arg VERSION=1.1.1 -t hangzhang714128/jiang13-forum:1.1.1 -t hangzhang714128/jiang13-forum:latest .
docker push hangzhang714128/jiang13-forum:1.1.1
docker push hangzhang714128/jiang13-forum:latest
```
